    ...
    <main className={styles.screen}>
      <div className={styles.slider}>
        ...
        <section className={styles.slide}>
          ...
          <img src="/logos/sihlspace_003a_orange.svg" alt="" className={styles.slideLogo} />
          <div className={`${styles.quote} ${styles.quoteNeutral}`}>
            <p>Warum fühlst Du Dich allein?</p>
          </div>
          ...
          <p className={styles.bodyText}><strong>Beides zusammen erzeugt ein sehr einsames Gefühl.</strong></p>
        </section>
        ...
        <section className={`${styles.slide} ${styles.accentSlide}`}>
          <SlideBrand />
          <img src="/logos/sihlspace_003a_white.svg" alt="" className={styles.slideLogo} />
          <p className={styles.bodyLarge}>Was wir wissen</p>
          <p className={styles.bodyMedium}>Menschen aus allen Teilen der Welt, aus allen Kulturen und in allen Epochen der Geschichte haben schwere Zeiten erlebt – <strong>Flucht</strong>, <strong>Verlust</strong>, <strong>Gewalt</strong>, <strong>Angst</strong> um das eigene Leben und um geliebte Menschen.</p>
        </section>
        ...
        <section className={`${styles.slide} ${styles.accentSlide}`}>
          <SlideBrand />
          <img src="/logos/sihlspace_003a_white.svg" alt="" className={styles.slideLogo} />
          <p className={styles.bodyLarge}>Das sind keine Zeichen von Schwäche.</p>
          <p className={styles.bodyLarge}>Das sind Zeichen, dass du ein Mensch bist.</p>
        </section>
