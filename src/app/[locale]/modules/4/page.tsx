    ...
    <main className={styles.screen}>
      <div className={styles.slider}>
        <section className={styles.slide}>
          ...
          <span className={styles.bgNumber} aria-hidden="true">4</span>
          <p className={styles.sub}>SPÜREN, DASS DIESER MOMENT SICHER IST</p>
          <h1 className={styles.h1}>Hier und jetzt ankommen</h1>
        </section>
        ...
        <section className={styles.slide}>
          ...
          <p className={styles.bodyText}>
            Modul 4 wird gerade aufgebaut. Du kannst zur Übersicht zurückkehren und später
            weitermachen.
          </p>
