...
const cards: ModuleCard[] = [
  {
    ...
    bg: (
      <svg viewBox="0 0 228 88" preserveAspectRatio="xMaxYMid slice" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M40 44 Q90 4 150 18 Q200 30 260 8" fill="none" stroke="#5C4433" strokeWidth="4" strokeLinecap="round" opacity="0.22" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    bg: (
      <svg viewBox="0 0 228 88" preserveAspectRatio="xMaxYMid slice" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M20 96 Q86 26 162 54 Q214 74 264 42" fill="none" stroke="#B8893A" strokeWidth="9" strokeLinecap="round" opacity="0.14" />
  ...
  },
  {
    ...
    bg: (
      <svg viewBox="0 0 228 88" preserveAspectRatio="xMaxYMid slice" xmlns="http://www.w3.org/2000/svg">
        <path d="M120 96 Q160 38 220 26 Q252 20 280 26" fill="none" stroke="#9AA180" strokeWidth="22" strokeLinecap="round" opacity="0.6" />
        <path d="M110 100 Q154 30 218 18 Q250 12 280 16" fill="none" stroke="#E8D5B0" strokeWidth="9" strokeLinecap="round" opacity="0.4" />
        <path d="M132 96 Q170 44 222 32 Q252 26 280 30" fill="none" stroke="#9AA180" strokeWidth="4" strokeLinecap="round" opacity="0.4" />
      </svg>
    ),
  },
  {
    ...
    bg: (
      <svg viewBox="0 0 228 88" preserveAspectRatio="xMaxYMid slice" xmlns="http://www.w3.org/2000/svg">
        <path d="M40 78 Q110 50 180 60 Q220 66 260 56" fill="none" stroke="#3E5A6B" strokeWidth="28" strokeLinecap="round" opacity="0.7" />
        <path d="M30 86 Q108 60 180 70 Q224 76 260 68" fill="none" stroke="#3E5A6B" strokeWidth="14" strokeLinecap="round" opacity="0.5" />
        <path d="M50 70 Q116 44 180 52 Q216 56 260 48" fill="none" stroke="#3E5A6B" strokeWidth="5" strokeLinecap="round" opacity="0.3" />
      </svg>
    ),
  },
];
